        ...
        builder: (context, child) {
          return GSBox(
            style: GSStyle(
              ...
              borderRadius: 4,
              bg: $GSColors.primary0.withOpacity(0.08),
            ),
            child: GSVStack(
              ...
              children: [
                ...
                GSVStack(
                  ...
                  children: [
                    ...
                    //----- Meta Descr Category --------
                    GSText(
                      text: '${productModel.meta}',
                      size: GSSizes.$xs,
                      style: GSStyle(
                          textStyle: TextStyle(color: $GSColors.textLight600)),
                    ),
                  ],
                ),
                //----- Price and Wishlist--------
                  ...
                  children: [
                    ...
                    MouseRegion(
                      ...
                      child: GsGestureDetector(
                        onPressed: () {
                          if (wishlistStateNotifier.wishlistProducts
                              .contains(productModel)) {
                            wishlistStateNotifier
                                .removeFromWishList(productModel);
                          } else {
                            wishlistStateNotifier.addToWishList(productModel);
                          }
                        },
                        child: GSIcon(
                          icon: wishlistStateNotifier.wishlistProducts
                                  .contains(productModel)
                              ? Icons.favorite
